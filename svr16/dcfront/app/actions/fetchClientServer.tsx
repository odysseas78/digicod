...
export default async function fetchClientServer(type:any, path: any, data: any, browserFingerprint?: string | null) {
  // const prms = { u: key, p: JSON.stringify(params)}

  
  const urlParams = data ? `?${createQueryString(data)}` : ''
  ...
  const urldss = type === "GET" ? `https://api.${host}/${path}/${urlParams}`:`https://api.${host}/${path}/`
