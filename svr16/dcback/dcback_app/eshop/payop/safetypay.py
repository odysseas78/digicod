...
def safetypay_send(type, orderqs, id, amount, currency, urlOk, urlKo, email, name, ip):
    ...
    result = create_invoice(paymentMethod='704', amount=str(amount), currency=currency, items=items, orderid=str(id), 
